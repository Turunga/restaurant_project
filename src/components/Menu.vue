                ...
                <v-col cols="12" md="4" v-for="item in menuItems":key="item">
                    <v-card>
                        <v-card color="orange">
                            ...
                            <v-card-text>
                            {{ item.price }}
                            <v-btn variant="tonal" @click="addtoOrder(item)"> order</v-btn>
                            </v-card-text>
                        </v-card>
                    </v-card>
...
const menuItems = [
    ...
    },
    {
        ...
        size: "None",
        offers: "None",
        image: "https://unsplash.com/photos/sausage-on-black-round-pan-cSxpCQrRlo"
    },
    {
        name: "Soda",
        price: 100,
        description: "Perfectly juicy and delicious",
        size: "Large",
        offers: "None",
...
function calculateTotalAmount(price){totalOrderAmount += price}
